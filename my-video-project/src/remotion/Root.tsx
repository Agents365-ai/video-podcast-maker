...
import { z } from "zod";
import { NeijingShangguTianzhen1Video } from "./NeijingShangguTianzhen1Video";
...
export const defaultVideoProps: VideoProps = {
  ...
  // 音频 — BGM 使用 /Users/liurainbow/Music/Music/禅音静心.MP3
  bgmVolume: 0.06,
...
const NEIJING_ID = "NeijingShangguTianzhen1";
const NEIJING_VERTICAL_ID = "NeijingShangguTianzhen1Vertical";
...
export const RemotionRoot = () => {
  return (
    <>
      ...
      <Composition
        id={NEIJING_ID}
        component={NeijingShangguTianzhen1Video}
      ...
      {/* 《黄帝内经》导读第1讲 封面 */}
      <Still
        id="NeijingShangguTianzhen1Thumbnail9x16"
        component={Thumbnail}
        width={1080}
        height={1920}
        defaultProps={{
